...
def bestGA(population, new_population, param):
    """
        ...
        :param population:      List of :class:`~src.Individual.MixedIntIndividual` objects containing the previous generation
        :param new_population:  List of :class:`~src.Individual.MixedIntIndividual` objects containing the new generation
        :param param:           :class:`~src.Parameters.Parameters` object for storing all parameters, options, etc.
...
def best(population, new_population, param):
    """
        ...
        :param population:      List of :class:`~src.Individual.FloatIndividual` objects containing the previous generation
        :param new_population:  List of :class:`~src.Individual.FloatIndividual` objects containing the new generation
        :param param:           :class:`~src.Parameters.Parameters` object for storing all parameters, options, etc.
        :returns:               A slice of the sorted new_population list.
    """
    if param.elitist:
...
def pairwise(population, new_population, param):
    """
        ...
        make the final selection. Intended for use with a :class:`~src.Sampling.MirroredSampling`
