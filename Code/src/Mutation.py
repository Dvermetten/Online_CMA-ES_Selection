...
def adaptStepSize(individual):
    """
        ...
        :param individual:  The :class:`~src.Individual.FloatIndividual` object whose step size should be adapted
    """
...
def addRandomOffset(individual, param, sampler):
    """
        ...
        :param individual:  :class:`~src.Individual.FloatIndividual` to be mutated
        :param param:       :class:`~src.Parameters.Parameters` object to store settings
        :param sampler:     :mod:`~src.Sampling` module from which the random values should be drawn
    """
...
def mutateBitstring(individual):
    """
        ...
        :param individual:  :mod:`~src.Individual` with a bit-string as genotype to undergo p=1/n mutation
    """
...
def mutateIntList(individual, param, num_options_per_module):
    """
        ...
        :param individual:              :class:`~src.Individual.MixedIntegerIndividual` whose integer-part will be mutated
        :param param:                   :class:`~src.Parameters.Parameters` object
        :param num_options_per_module:  List :data:`~src.num_options` with the number of available modules per module
...
def mutateFloatList(individual, param, options):
    """
        ...
        :param individual:  :class:`~src.Individual.MixedIntegerIndividual` whose integer-part will be mutated
        :param param:       :class:`~src.Parameters.Parameters` object
        :param options:     List of tuples :data:`~src.options` with the number of tunable parameters per module
    """
...
def mutateMixedInteger(individual, param, options, num_options_per_module):
    """
        ...
        :param param:                   :class:`~src.Parameters.Parameters` object
        :param options:                 List of tuples :data:`~src.options` with the number of tunable parameters per module
        :param num_options_per_module:  List :data:`~src.num_options` with the number of available modules per module position
...
def MIES_MutateDiscrete(individual, begin, end, u, num_options, options):
    """
        ...
        :param num_options:     List :data:`~src.num_options` with the number of available modules per module position
                                that are available to choose from
        :param options:         List of tuples :data:`~src.options` with the number of tunable parameters per module
