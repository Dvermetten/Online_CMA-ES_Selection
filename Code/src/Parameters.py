...
from src.Utils import initializable_parameters
import numpy as np
...
class Parameters(BaseParameters):
    """
        ...
        :param values:          Dictionary in the form of ``{'name': value}`` of initial values for allowed parameters.
                                Any values for names not in :data:`src.Utils.initializable_parameters` are ignored.
    """
    ...
    def __init_values(self, values):
        """
            ...
            :param values:  Dictionary in the form of ``{'name': value}`` of initial values for allowed parameters.
                            Any values for names not in :data:`src.initializable_parameters` are ignored
        """
