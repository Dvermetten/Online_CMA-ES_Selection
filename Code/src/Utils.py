...
def getFitness(individual):
    """
        ...
        :param individual:  Some object of one of the classes from the :class:`~src.Individual` module
...
class ESFitness(object):
    """
        ...
        :param target:          What value to use as target for calculating ERT. Default set in :mod:`~src.Config`
