...
def weighted(pop, param):
    """
        ...
        of the given population, using the weights stored in the :class:`~src.Parameters.Parameters` object.
        Set weights to 1/n to simply use the arithmetic mean

        :param pop:     The population to be recombined
        :param param:   :class:`~src.Parameters.Parameters` object, of which ``param.weights``
